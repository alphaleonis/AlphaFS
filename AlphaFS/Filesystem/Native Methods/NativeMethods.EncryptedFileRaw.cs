...
namespace Alphaleonis.Win32.Filesystem
{
   partial class NativeMethods
   {
      ...
      [DllImport("Advapi32.dll", SetLastError = true, CharSet = CharSet.Unicode, EntryPoint = "OpenEncryptedFileRawW")]
      ...
      [DllImport("Advapi32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
      [SuppressMessage("Microsoft.Security", "CA5122:PInvokesShouldNotBeSafeCriticalFxCopRule")]
      internal static extern int ReadEncryptedFileRaw([MarshalAs(UnmanagedType.FunctionPtr)] EncryptedFileRawExportCallback pfExportCallback, IntPtr pvCallbackContext, SafeEncryptedFileRawHandle pvContext);
